...
func _process(_delta):
	$CanvasLayer/Control/Coins.text = str(Global.Coin)
...
func _button_disabled(thirdnoda, secondnoda, firstnoda, subnoda, noda):
	...
	Noda.interpolate_property(FirstNoda, "rect_scale", Vector2(1.2, 1.0), Vector2(1.0, 1.0), 1.0, Noda.TRANS_ELASTIC, Noda.EASE_OUT)
	Noda.start()
